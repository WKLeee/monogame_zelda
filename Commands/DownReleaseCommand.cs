...
{
    class DownReleaseCommand : ICommand
    {
        private readonly PlayerSprite mySprite;
        private readonly MarioMoveState.Command command = MarioMoveState.Command.DownRelease;
        private readonly GraphicsDeviceManager graphics;

        public DownReleaseCommand(PlayerSprite sprite, GraphicsDeviceManager device)
        {
            graphics = device;
            mySprite = sprite;
        }
